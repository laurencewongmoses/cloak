 ...
 */
@Configuration
@MapperScan(basePackages = "com.cloak.technical.dao", sqlSessionTemplateRef = "stockHistorySqlSessionTemplate")
public class DataSourceStockTechnical {

    @Bean(name = "stockHistoryDataSource")
    @ConfigurationProperties(prefix = "spring.datasource.technical")
    ...
    public SqlSessionFactory testSqlSessionFactory(@Qualifier("stockHistoryDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:com/cloak/technical/*.xml"));
